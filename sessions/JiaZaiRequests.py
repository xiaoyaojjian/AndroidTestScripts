...
# FileName JiaZaiRequests.py
# Author: HeyNiu
# Created Time: 20160804
"""
B request
"""
...
class JiaZaiRequests(base.Request.Request):
    ...
    def __get_session_header(self, method_name):
        ...
        arr = (des[1], method_name, des[0], self.conf['DeviceId'], self.conf['Model'], self.conf['Release'],
               ...
               self.uType, "4423292378263683538", "885565804033515842", self.conf['AppBuild'],
               "4Pm8+qHJywM1NV2IkrHTlCsqMQuo1b8S1CppSr6Qzow=")
    ...
    def start(self):
        self.start_thread_pool(self.thread_pool, 2)

if __name__ == '__main__':
    JiaZaiRequests().start()
